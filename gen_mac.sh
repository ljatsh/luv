...
gyp -f xcode -Goutput_dir=build --generator-output=build --depth=. -Dtarget_arch=x86_64 -Dhost_arch=x86_64 -Duv_library=static_library  -Ilibuv/common.gypi  src/luv.gyp
